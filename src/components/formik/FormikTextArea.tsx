...
interface FormikTextAreaProps extends React.InputHTMLAttributes<HTMLTextAreaElement> {
  name: string;
  label?: string;
}

export const FormikTextArea: React.FC<FormikTextAreaProps> = ({ label, ...props }) => {
